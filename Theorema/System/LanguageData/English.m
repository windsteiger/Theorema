...
(* Theorema`Provers`Common` *)
	...
	MessageName[local, "usage", lang] = "local is an option for the constructor makePRFSIT and a selector for the PRFSIT$ datastructure.";
	MessageName[ruleSetup, "usage", lang] = "ruleSetup is an option for the constructor makePRFSIT and a selector for the PRFSIT$ datastructure.";
	MessageName[rules, "usage", lang] = "rules is an option for the constructor makePRFSIT and a selector for the PRFSIT$ datastructure.";
	MessageName[ruleActivity, "usage", lang] = "ruleActivity is an option for the constructor makePRFSIT and a selector for the PRFSIT$ datastructure.";
	MessageName[rulePriority, "usage", lang] = "rulePriority is an option for the constructor makePRFSIT and a selector for the PRFSIT$ datastructure.";
	MessageName[strategy, "usage", lang] = "strategy is an option for the constructor makePRFSIT and a selector for the PRFSIT$ datastructure.";
