...
(* UNTRANSLATED *)
	...
	MessageName[ $codeEvaluationFunction, "usage", lang] = "$codeEvaluationFunction is the 'CellEvaluationFunction' of Theorema code cells.";
	...
	MessageName[ fmlHyperlink, "usage", lang] = "";
	...
	MessageName[ $inputEvaluationFunction, "usage", lang] = "$inputEvaluationFunction is the 'CellEvaluationFunction' of Theorema input cells.";
	MessageName[ $inputProlog, "usage", lang] = "$inputProlog is evaluated before evaluating Theorema input cells.";
	MessageName[ insertNewEnv, "usage", lang] = "";
	...
	MessageName[ makeCellFrameLabel, "usage", lang] = "";
	...
	MessageName[ makeFmlKey, "usage", lang] = "makeFmlKey[ id, src] returns the formula key corresponding to ID 'id' and source 'src'.";
	...
	MessageName[ selectCells, "usage", lang] = "";
	...
	MessageName[ sourceLabel, "usage", lang] = "";
