TabView[{"knowledge" -> 
   Pane[Row[{Theorema`Interface`GUI`Private`FORM[
       {{"ID:794877354", "Source:/home/wwindste/Theorema.2/Theorema/Theorema/\
Documentation/English/TheoremaNotebooks/FirstTour.nb"}, "surjective"}], 
      Theorema`Interface`GUI`Private`FORM[{{"ID:1636230891", "Source:/home/ww\
indste/Theorema.2/Theorema/Theorema/Documentation/English/TheoremaNotebooks/F\
irstTour.nb"}, "composition"}], Theorema`Interface`GUI`Private`FORM[
       {{"ID:112294143", "Source:/home/wwindste/Theorema.2/Theorema/Theorema/\
Documentation/English/TheoremaNotebooks/FirstTour.nb"}, 
        "u:X\[RightArrow]Y"}]}, ", "], 500], 
...
, whether the proof text for the rule will be activated. (ruleTextActive)"], 
     ...
     "Proof Search Limits" -> Column[{Labeled[30, "Search Depth:", Left], 
        Labeled[105, "Search Time:", Left]}], "Proof Simplification" -> 
      Column[{Null, Null, Null}], "Interactive Proving" -> 
      Column[{Null, Null, Null}], "Proof Cells" -> "automatic", 
     "statistics" -> Column[{Labeled[2.612406`6.567555670380478, 
...
r/p978540590-1.m"]]}, Spacer[5]]}, ImageSize -> Automatic]
