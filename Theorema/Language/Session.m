...
openArchive[name_String] :=
    Module[ {nb = EvaluationNotebook[], archiveNotebookPath, posBrowser},
        archiveNotebookPath = FileNameJoin[{$TheoremaArchiveDirectory, getArchiveNotebookPath[ name]}];
...
closeArchive[_String] :=
    Module[ {nb = EvaluationNotebook[], currNB = CurrentValue["NotebookFullFileName"], archName, archFile, archivePath, archiveNotebookPath},
        End[];
        archName = $Context;
