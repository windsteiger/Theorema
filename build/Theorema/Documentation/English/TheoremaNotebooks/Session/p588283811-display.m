TabView[{"knowledge" -> {Theorema`Interface`GUI`Private`FORM[
     {{"ID:290292271", "Source:/home/wwindste/Theorema.2/Theorema/Theorema/Do\
cumentation/English/TheoremaNotebooks/Session.nb"}, "2"}], 
    Theorema`Interface`GUI`Private`FORM[{{"ID:784538540", "Source:/home/wwind\
ste/Theorema.2/Theorema/Theorema/Documentation/English/TheoremaNotebooks/Sess\
ion.nb"}, "3"}]}, "built-in" -> Column[{Style["Sets", "ComponentEmpty"], 
     ...
     OpenerView[{"Logic", Column[{Row[{"\[Checkmark] ", Style["And", 
            "ComponentActive"], ",", Style["Or", "ComponentActive"], ",", 
           Style["Implies", "ComponentActive"], ",", Style["Iff", 
            "ComponentActive"], ",", Style["Equal", "ComponentActive"]}], 
         Row[{Style["Not", "ComponentInactive"], ",", Style["Forall", 
            "ComponentInactive"], ",", Style["Exists", "ComponentInactive"], 
           ",", Style["Let", "ComponentInactive"], ",", 
...
the proof text for the rule will be activated. (ruleTextActive)"], Spacer[5], 
            "Handle a disjunction in the goal"}], LineBreakWithin -> False], 
...
the proof text for the rule will be activated. (ruleTextActive)"], Spacer[5], 
          ...
          LineBreakWithin -> False], Style[Row[{"(15)", Spacer[2], 
            Tooltip["\:270d", "Specifies, whether the proof text for the rule \
will be activated. (ruleTextActive)"], Spacer[5], "Goal rewriting based on \
...
s, whether the proof text for the rule will be activated. (ruleTextActive)"], 
     ...
     "Proof Search Limits" -> Column[{Labeled[30, "Search Depth:", Left], 
      ...
      Column[{Null, Null, Null}], "Initial status of nested proof cells" -> 
      "automatic", "statistics" -> 
      Column[{Labeled[0.675984`5.9804514144926415, 
...
Theorema.2/Theorema/Theorema/Documentation/English/TheoremaNotebooks/Session/\
p588283811.m"]]}, Spacer[5]]}, ImageSize -> Automatic]
